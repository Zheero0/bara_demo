...
export const mockJobs: Omit<Job, 'id' | 'postedBy' | 'createdAt'>[] = [
  ...
  { title: 'Content Writer for Tech Blog', category: 'Writing', price: 1500, location: 'Manchester', jobType: 'On-site', description: 'Write 4 high-quality blog posts per month about software development trends.' },
  { title: 'React Native Developer for MVP', category: 'Mobile Development', price: 6000, location: 'Remote', jobType: 'Remote', description: 'Develop a cross-platform MVP for a new social networking app.' },
  { title: 'Data Visualization Dashboard', category: 'Data Science', price: 4500, location: 'Edinburgh', jobType: 'On-site', description: 'Create an interactive data dashboard using D3.js or a similar library to visualize sales data.' },
];
